...
$(selector).signature({color: 'blue', guideline: true}) */
  ...
  console.log('Signature changed');
		...
		_create: function() {
			...
			try {
				this.canvas = $('<canvas width="1000" height="1414">' + this.options.notAvailable + '</canvas>')[0];
				...
				this.canvas.setAttribute('height', 1414);
			...
			var img = document.getElementById('odontogram');
		...
		toSVG: function() {
			var attrs1 = (this.options.svgStyles ? 'style="fill: none"' :
				'fill="none"');
			...
			var svg_ttd = '<svg xmlns="http://www.w3.org/2000/svg" width="1000px" height="1414px">\n' +
				'	<g ' + attrs1 + '>\n' +
