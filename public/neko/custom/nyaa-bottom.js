$(".link-logout").on("click", function() {event.preventDefault();$("#logout-form").submit();});
if ( $.isFunction($.fn.dataTable) ) {
  //$.fn.dataTable.ext.errMode=()=>neko_d_custom_error("Terjadi Kesalahan dalam pemuatan data. Mohon untuk me-refresh halaman ini.");
  $.fn.dataTable.ext.errMode = function ( settings, helpPage, message ) { 
    neko_d_custom_error("Terjadi Kesalahan dalam pemuatan data. Mohon untuk me-refresh halaman ini.");
    console.log(message);
  };
