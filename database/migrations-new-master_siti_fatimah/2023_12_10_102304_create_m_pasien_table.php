...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('m_pasien', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->string('PatientCity', 150)->nullable();
            $table->string('PatientProvince', 150)->nullable();
            $table->string('PatientAddress', 150)->nullable();
        });
    }
    ...
    {
        Schema::connection('mysql2')->dropIfExists('m_pasien');
    }
};
