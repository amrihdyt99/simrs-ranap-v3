...
class CreatePengkajianNoeonatusNyeriTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pengkajian_noeonatus_nyeri', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('pengkajian_noeonatus_nyeri');
    }
}
