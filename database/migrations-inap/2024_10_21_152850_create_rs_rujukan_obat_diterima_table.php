...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rs_rujukan_obat_diterima', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('reg_no');
            $table->string('med_rec');
            $table->string('kode_surat_rujukan');
            $table->string('item_id_terima');
            $table->string('quantity_terima')->nullable();
            $table->string('item_unit_code_terima')->nullable();
    ...
    {
        Schema::dropIfExists('rs_rujukan_obat_diterima');
    }
};
