...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('transfer_internal_alat_terpasang', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('reg_no');
            $table->string('med_rec');
            $table->string('kode_transfer_internal');
            $table->text('nama_alat_terpasang');
            $table->dateTime('waktu_alat_terpasang');
    ...
    {
        Schema::dropIfExists('transfer_internal_alat_terpasang');
    }
};
