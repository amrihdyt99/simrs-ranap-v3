...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rs_edukasi_pasien_rehab', function (Blueprint $table) {
            ...
            $table->string('edukasi_lain_lain_rehabilitasi')->nullable();
            $table->date('tgl_tehnik_rehabilitasi')->nullable();
            $table->date('tgl_lain_lain_rehabilitasi')->nullable();
            $table->string('tingkat_paham_tehnik_rehabilitasi')->nullable();
            $table->string('tingkat_paham_lain_lain_rehabilitasi')->nullable();
            $table->string('tingkat_paham_lain_lain_text_rehabilitasi')->nullable();
            $table->string('metode_edukasi_tehnik_rehabilitasi')->nullable();
            $table->string('metode_edukasi_lain_lain_rehabilitasi')->nullable();
        });
    }
