...
class CreateNewSkriningGiziAnakTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        //drop old table
        Schema::rename('skrining_gizi_anak', 'skrining_gizi_anak_old');
    ...
    {
        // Schema::dropIfExists('new_skrining_gizi_anak');
    }
}
