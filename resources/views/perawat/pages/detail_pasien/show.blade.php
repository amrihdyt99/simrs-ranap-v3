                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select id="suku" name="suku" class="form-control">
                                                ...
                                                <option>Batak</option>
                                                <option value="0005^001" {{ $pasien->GCRace === '0005^001' ? 'selected':'' }}>Aceh</option>
                                                <option value="0005^002" {{ $pasien->GCRace === '0005^002' ? 'selected':'' }}>Batak</option>
                                                <option value="0005^003" {{ $pasien->GCRace === '0005^003' ? 'selected':'' }}>Minang</option>
                                                <option value="0005^004" {{ $pasien->GCRace === '0005^004' ? 'selected':'' }}>Sunda</option>
                                                <option value="0005^005" {{ $pasien->GCRace === '0005^005' ? 'selected':'' }}>Jawa</option>
                                                <option value="0005^006" {{ $pasien->GCRace === '0005^006' ? 'selected':'' }}>Madura</option>
                                                <option value="0005^007" {{ $pasien->GCRace === '0005^007' ? 'selected':'' }}>Bali</option>
                                                <option value="0005^008" {{ $pasien->GCRace === '0005^008' ? 'selected':'' }}>Sasak</option>
                                                <option value="0005^009" {{ $pasien->GCRace === '0005^009' ? 'selected':'' }}>Timor</option>
                                                <option value="0005^010" {{ $pasien->GCRace === '0005^010' ? 'selected':'' }}>Dayak</option>
                                                <option value="0005^011" {{ $pasien->GCRace === '0005^011' ? 'selected':'' }}>Minahasa</option>
                                                <option value="0005^012" {{ $pasien->GCRace === '0005^012' ? 'selected':'' }}>Toraja</option>
                                                <option value="0005^013" {{ $pasien->GCRace === '0005^013' ? 'selected':'' }}>Makassar</option>
                                                <option value="0005^014" {{ $pasien->GCRace === '0005^014' ? 'selected':'' }}>Bugis</option>
                                                <option value="0005^015" {{ $pasien->GCRace === '0005^015' ? 'selected':'' }}>Chinese</option>
                                                <option value="0005^016" {{ $pasien->GCRace === '0005^016' ? 'selected':'' }}>Ambon</option>
                                                <option value="0005^017" {{ $pasien->GCRace === '0005^017' ? 'selected':'' }}>Palembang</option>
                                                <option value="0005^018" {{ $pasien->GCRace === '0005^018' ? 'selected':'' }}>Bangka</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select id="pekerjaan" name="pekerjaan" class="form-control">
                                                ...
                                                <option value="X0012^03" {{ $pasien->GCOccupation === 'X0012^03' ? 'selected':'' }}>Lainnya</option>
                                                <option value="X0012^04" {{ $pasien->GCOccupation === 'X0012^04' ? 'selected':'' }}>Tidak Kerja</option>
                                                <option value="X0012^06" {{ $pasien->GCOccupation === 'X0012^06' ? 'selected':'' }}>Wiraswasta / Dagang / Jasa</option>
                                                <option value="X0012^07" {{ $pasien->GCOccupation === 'X0012^07' ? 'selected':'' }}>Petani / Nelayan</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <select id="pendidikan" name="pendidikan" class="form-control">
                                                <option value=""></option>
                                                <option value="X0013^01" {{ $pasien->GCEducation === 'X0013^01' ? 'selected':'' }}>TK</option>
                                                <option value="X0013^02" {{ $pasien->GCEducation === 'X0013^02' ? 'selected':'' }}>SD</option>
                                                <option value="X0013^03" {{ $pasien->GCEducation === 'X0013^03' ? 'selected':'' }}>SMP</option>
                                                <option value="X0013^04" {{ $pasien->GCEducation === 'X0013^04' ? 'selected':'' }}>SMA</option>
                                                <option value="X0013^05" {{ $pasien->GCEducation === 'X0013^05' ? 'selected':'' }}>D-1</option>
                                                <option value="X0013^06" {{ $pasien->GCEducation === 'X0013^06' ? 'selected':'' }}>D-3</option>
                                                <option value="X0013^07" {{ $pasien->GCEducation === 'X0013^07' ? 'selected':'' }}>S-1</option>
                                                <option value="X0013^08" {{ $pasien->GCEducation === 'X0013^08' ? 'selected':'' }}>S-2</option>
                                                <option value="X0013^09" {{ $pasien->GCEducation === 'X0013^09' ? 'selected':'' }}>S-3</option>
                                            </select>
                                        </div>
                                    </div>
