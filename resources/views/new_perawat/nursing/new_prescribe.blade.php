<div class="card card-default">
    ...
    <table class="table table-bordered table-hover table-sm nursing">
        <thead>
        <tr>
            <th class="text-sm">Tanggal Pemberian</th>
        ...
        @foreach($obat as $row)
            <tr>
                <td class="text-sm">{{app(\App\Http\Controllers\ZxcNyaaUniversal\UniversalFunctionController::class)->carbon_deteksi_day_format($row->tgl_pemberian_0)}}</td>
                <td class="text-sm">{{$row->nama_obat}}</td>
...
<div class="card card-default">
    ...
    {{-- <form action="{{route('perawat.drugs.store')}}" method="POST"> --}}
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <table class="table table-bordered table-hover treatment table-sm">
                    ...
                    <tr>
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[1][rentang_jam]" value="1">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[2][rentang_jam]" value="2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[3][rentang_jam]" value="3"
                                       value="3">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[4][rentang_jam]" value="4"
                                       value="4">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[5][rentang_jam]" value="5"
                                       value="5">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[6][rentang_jam]" value="6"
                                       value="6">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[7][rentang_jam]" value="7"
                                       value="7">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[8][rentang_jam]" value="8"
                                       value="8">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[9][rentang_jam]" value="9"
                                       value="9">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[10][rentang_jam]" value="10"
                                       value="10">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[11][rentang_jam]" value="11"
                                       value="11">
                    ...
                    <tr>
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[12][rentang_jam]" value="12"
                                       value="option2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[13][rentang_jam]" value="13"
                                       value="option2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[14][rentang_jam]" value="14"
                                       value="option2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[15][rentang_jam]" value="15"
                                       value="option2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[16][rentang_jam]" value="16"
                                       value="option2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[17][rentang_jam]" value="17"
                                       value="option2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[18][rentang_jam]" value="18"
                                       value="option2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[19][rentang_jam]" value="19"
                                       value="option2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[20][rentang_jam]" value="20"
                                       value="option2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[21][rentang_jam]" value="21"
                                       value="option2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[22][rentang_jam]" value="22"
                                       value="option2">
                        ...
                        <td class="text-sm">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="data_perjam[23][rentang_jam]" value="23"
                                       value="option2">
            ...
            <button type="button" onclick="addNursingDrugs()" class="btn btn-sm btn-primary float-right">Submit</button>
