    ...
    <div class="col-md-3">
        ...
        <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-sm btn-primary " onclick="addVital('weight','groupweight')"><i class="fa fa-save mr-2"></i>Save</button>
    ...
    <div class="col-md-3">
        ...
        <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-sm btn-primary " onclick="addVital('index masa tubuh','')"><i class="fa fa-save mr-2"></i>Save</button>
                </div>
