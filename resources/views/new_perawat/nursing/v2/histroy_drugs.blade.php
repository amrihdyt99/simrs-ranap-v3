  ...
  <table class="table1 w-100" style="border-collapse: collapse; border: 1px solid black;">
    <thead>
      <tr>
        ...
        <th class="" style="border: 1px solid black;">Cara Pemberian</th>
        <th class="" style="border: 1px solid black;">Antibiotik</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="" style="border: 1px solid black;">{{ $row->cara_pemberian }}</td>
        <td class="" style="border: 1px solid black;">{{ $row->antibiotik }}</td>
