<div class="modal fade" id="riwayatdetailnews" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modalDetailContent">
                <table id="table_riwayat_detail_news" class="table1 w-100" style="text-align: justify-center;">
                    <tbody>
                        <tr>
                            <td></td>
