...
<div class="modal fade" id="riwayat-geriatri-show" tabindex="-1" role="dialog" aria-labelledby="resikoJatuhDetailModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table id="riwayat-data-geriatri" class="table1 w-100">
                ...
                <br><br><br>
                <h3><b>INTERVENSI PENCEGAHAN PASIEN JATUH GERIATRI</b></h3>
                <table class="table1 w-100" id="riwayat-data-geriatri2">
                    <!-- Risiko Rendah -->
                    <tr>
                        <td rowspan="3">
                        ...
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_rendah[]" value="Jelaskan dan letakkan protokol risiko jatuh di dekat pasien dan atau keluarga" id="rendah1">
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_rendah[]" value="Monitor Kondisi Umum Pasien dan Tanda Vital" id="rendah2">
                            <label for="rendah2">Monitor Kondisi Umum Pasien dan Tanda Vital</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_rendah[]" value="Pastikan pengaman tempat tidur selalu tertutup saat pasien tidur" id="rendah3">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_sedang[]" value="Jelaskan dan letakkan protokol risiko jatuh di dekat pasien dan atau keluarga" id="sedang1">
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_sedang[]" value="Sarankan untuk minta bantuan" id="sedang2">
                            <label for="sedang2">Sarankan untuk minta bantuan</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_sedang[]" value="Tempatkan bel panggilan dalam jangkauan tangan pasien" id="sedang3">
                            <label for="sedang3">Tempatkan bel panggilan dalam jangkauan tangan pasien</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_sedang[]" value="Tempatkan benda-benda milik pasien di dekat pasien" id="sedang4">
                            <label for="sedang4">Tempatkan benda-benda milik pasien di dekat pasien</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_sedang[]" value="Pastikan tempat tidur dalam posisi rendah dan roda terkunci" id="sedang5">
                            <label for="sedang5">Pastikan tempat tidur dalam posisi rendah dan roda terkunci</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_sedang[]" value="Pastikan pakaian yang digunakan pasien di atas mata kaki" id="sedang6">
                            <label for="sedang6">Pastikan pakaian yang digunakan pasien di atas mata kaki</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_sedang[]" value="Bantu pasien saat transfer atau ambulasi" id="sedang7">
                            <label for="sedang7">Bantu pasien saat transfer atau ambulasi</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_sedang[]" value="Pasangkan pengaman sisi tempat tidur" id="sedang8">
                            <label for="sedang8">Pasangkan pengaman sisi tempat tidur</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_sedang[]" value="Pastikan klip pasien risiko jatuh terpasang pada gelang pasien dan lambang risiko" id="sedang9">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Jelaskan dan letakkan protokol risiko jatuh di dekat pasien dan atau keluarga" id="tinggi1">
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Sarankan untuk minta bantuan" id="tinggi2">
                            <label for="tinggi2">Sarankan untuk minta bantuan</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Tempatkan bel panggilan dalam jangkauan tangan pasien" id="tinggi3">
                            <label for="tinggi3">Tempatkan bel panggilan dalam jangkauan tangan pasien</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Tempatkan benda-benda milik pasien di dekat pasien" id="tinggi4">
                            <label for="tinggi4">Tempatkan benda-benda milik pasien di dekat pasien</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Pastikan tempat tidur dalam posisi rendah dan roda terkunci" id="tinggi5">
                            <label for="tinggi5">Pastikan tempat tidur dalam posisi rendah dan roda terkunci</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Pastikan pakaian yang digunakan pasien di atas mata kaki" id="tinggi6">
                            <label for="tinggi6">Pastikan pakaian yang digunakan pasien di atas mata kaki</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Bantu pasien saat transfer atau ambulasi" id="tinggi7">
                            <label for="tinggi7">Bantu pasien saat transfer atau ambulasi</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Pasangkan pengaman sisi tempat tidur" id="tinggi8">
                            <label for="tinggi8">Pasangkan pengaman sisi tempat tidur</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Pastikan klip pasien risiko jatuh terpasang pada gelang pasien dan lambang risiko" id="tinggi9">
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Tawarkan ke pasien untuk ke toilet setiap 4 jam" id="tinggi10">
                            <label for="tinggi10">Tawarkan ke pasien untuk ke toilet setiap 4 jam</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Pasangkan tali pengaman bila perlu" id="tinggi11">
                            <label for="tinggi11">Pasangkan tali pengaman bila perlu</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Berikan efek dari obat anestesi kepada pasien atau keluarga" id="tinggi12">
                            <label for="tinggi12">Berikan efek dari obat anestesi kepada pasien atau keluarga</label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" disabled name="intervensi_resiko_jatuh_tinggi[]" value="Berikan orientasi ruangan sekitar kepada pasien" id="tinggi13">
