      ...
      <table class="w-100">
        <tbody>
          <tr>
            ...
            <td>
              <input type="radio" id="rekon_penggunaan_obat_tidak" value="0" name="ttd[penggunaan_sebelum_admisi]" >
              <label for="rekon_penggunaan_obat_tidak">Tidak menggunakkan obat sebelum admisi</label>
            </td>
            <td>
              <input type="radio" id="rekon_penggunaan_obat_ya" value="1" name="ttd[penggunaan_sebelum_admisi]" >
            ...
            <td>
              <div class="form-group row ">
                ...
                <div class="input-group col-sm-8">
                  <input id="asper_khusus_abdomen" type="datetime-local" class="form-control text-sm" name="ttd[time_ttd_dpjp]" >
                </div>
              </div>
            </td>
            <td>
              <div class="form-group row ">
                <label for="inputPassword3" class="col-sm-4 text-sm">Tanggal / Pukul</label>
                <div class="input-group col-sm-8">
                  <input id="asper_khusus_abdomen" type="datetime-local" class="form-control text-sm" name="ttd[time_ttd_ppds]" >
                </div>
              </div>
            </td>
            <td>
              <div class="form-group row ">
                <label for="inputPassword3" class="col-sm-4 text-sm">Tanggal / Pukul</label>
                <div class="input-group col-sm-8">
                  <input id="asper_khusus_abdomen" type="datetime-local" class="form-control text-sm" name="ttd[time_ttd_perawat]" >
                </div>
              </div>
            </td>
          </tr>
