...
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link active" href="#pengkajian_awal" data-toggle="tab">Edukasi Pengkajian Awal</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="#anastesi" data-toggle="tab">Edukasi Anastesi</a>
    </li>
</ul>
<div class="tab-content">
    <div class="tab-pane active" id="pengkajian_awal">
    ...
    <div class="tab-pane" id="anastesi">
