    ...
    <table class="table1 table">
        ...
        <tbody>
            <tr>
                ...
                <td><input type="date" class="form-control" name="tgl_diagnosa_penyebab_dokter" value="{{$edukasi_pasien_dokter->tgl_diagnosa_penyebab_dokter ?? null}}" disabled></td>
                <td>
                    <input type="radio" name="tingkat_paham_diagnosa_penyebab_dokter" value="Mudah mengerti"
                        id="tingkat_paham_diagnosa_penyebab_mudah" {{isset($edukasi_pasien_dokter->tingkat_paham_diagnosa_penyebab_dokter) ? $edukasi_pasien_dokter->tingkat_paham_diagnosa_penyebab_dokter=='Mudah mengerti' ? 'checked' : '' : ''}} disabled>
                    ...
                    <input type="radio" name="tingkat_paham_diagnosa_penyebab_dokter" value="Edukasi Ulang"
                        id="tingkat_paham_diagnosa_penyebab_edukasi" {{isset($edukasi_pasien_dokter->tingkat_paham_diagnosa_penyebab_dokter) ? $edukasi_pasien_dokter->tingkat_paham_diagnosa_penyebab_dokter=='Edukasi Ulang' ? 'checked' : '' : ''}} disabled>
                    ...
                    <input type="radio" name="tingkat_paham_diagnosa_penyebab_dokter" value="Hal Baru"
                        id="tingkat_paham_diagnosa_penyebab_baru" {{isset($edukasi_pasien_dokter->tingkat_paham_diagnosa_penyebab_dokter) ? $edukasi_pasien_dokter->tingkat_paham_diagnosa_penyebab_dokter=='Hal Baru' ? 'checked' : '' : ''}} disabled>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="tingkat_paham_penatalaksanaan_dokter" value="Mudah mengerti"
                        id="tingkat_paham_penatalaksanaan_mudah" {{isset($edukasi_pasien_dokter->tingkat_paham_penatalaksanaan_dokter) ? $edukasi_pasien_dokter->tingkat_paham_penatalaksanaan_dokter=='Mudah mengerti' ? 'checked' : '' : ''}} disabled>
                    ...
                    <input type="radio" name="tingkat_paham_penatalaksanaan_dokter" value="Edukasi Ulang"
                        id="tingkat_paham_penatalaksanaan_edukasi" {{isset($edukasi_pasien_dokter->tingkat_paham_penatalaksanaan_dokter) ? $edukasi_pasien_dokter->tingkat_paham_penatalaksanaan_dokter=='Edukasi Ulang' ? 'checked' : '' : ''}} disabled>
                    ...
                    <input type="radio" name="tingkat_paham_penatalaksanaan_dokter" value="Hal Baru"
                        id="tingkat_paham_penatalaksanaan_baru" {{isset($edukasi_pasien_dokter->tingkat_paham_penatalaksanaan_dokter) ? $edukasi_pasien_dokter->tingkat_paham_penatalaksanaan_dokter=='Hal Baru' ? 'checked' : '' : ''}} disabled>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="tingkat_paham_prosedur_diagnostik_dokter" value="Mudah mengerti"
                        id="tingkat_paham_prosedur_diagnostik_mudah" {{isset($edukasi_pasien_dokter->tingkat_paham_prosedur_diagnostik_dokter) ? $edukasi_pasien_dokter->tingkat_paham_prosedur_diagnostik_dokter=='Mudah mengerti' ? 'checked' : '' : ''}} disabled>
                    ...
                    <input type="radio" name="tingkat_paham_prosedur_diagnostik_dokter" value="Edukasi Ulang"
                        id="tingkat_paham_prosedur_diagnostik_edukasi" {{isset($edukasi_pasien_dokter->tingkat_paham_prosedur_diagnostik_dokter) ? $edukasi_pasien_dokter->tingkat_paham_prosedur_diagnostik_dokter=='Edukasi Ulang' ? 'checked' : '' : ''}} disabled>
                    ...
                    <input type="radio" name="tingkat_paham_prosedur_diagnostik_dokter" value="Hal Baru"
                        id="tingkat_paham_prosedur_diagnostik_baru" {{isset($edukasi_pasien_dokter->tingkat_paham_prosedur_diagnostik_dokter) ? $edukasi_pasien_dokter->tingkat_paham_prosedur_diagnostik_dokter=='Hal Baru' ? 'checked' : '' : ''}} disabled>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="tingkat_paham_manajemen_nyeri_dokter" value="Mudah mengerti"
                        id="tingkat_paham_manajemen_nyeri_mudah" {{isset($edukasi_pasien_dokter->tingkat_paham_manajemen_nyeri_dokter) ? $edukasi_pasien_dokter->tingkat_paham_manajemen_nyeri_dokter=='Mudah mengerti' ? 'checked' : '' : ''}} disabled>
                    ...
                    <input type="radio" name="tingkat_paham_manajemen_nyeri_dokter" value="Edukasi Ulang"
                        id="tingkat_paham_manajemen_nyeri_edukasi" {{isset($edukasi_pasien_dokter->tingkat_paham_manajemen_nyeri_dokter) ? $edukasi_pasien_dokter->tingkat_paham_manajemen_nyeri_dokter=='Edukasi Ulang' ? 'checked' : '' : ''}} disabled>
                    ...
                    <input type="radio" name="tingkat_paham_manajemen_nyeri_dokter" value="Hal Baru"
                        id="tingkat_paham_manajemen_nyeri_baru" {{isset($edukasi_pasien_dokter->tingkat_paham_manajemen_nyeri_dokter) ? $edukasi_pasien_dokter->tingkat_paham_manajemen_nyeri_dokter=='Hal Baru' ? 'checked' : '' : ''}} disabled>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="tingkat_paham_lain_lain_dokter" value="Mudah mengerti"
                        id="tingkat_paham_lain_lain_mudah" {{isset($edukasi_pasien_dokter->tingkat_paham_lain_lain_dokter) ? $edukasi_pasien_dokter->tingkat_paham_lain_lain_dokter=='Mudah mengerti' ? 'checked' : '' : ''}} disabled>
                    ...
                    <input type="radio" name="tingkat_paham_lain_lain_dokter" value="Edukasi Ulang"
                        id="tingkat_paham_lain_lain_edukasi" {{isset($edukasi_pasien_dokter->tingkat_paham_lain_lain_dokter) ? $edukasi_pasien_dokter->tingkat_paham_lain_lain_dokter=='Edukasi Ulang' ? 'checked' : '' : ''}} disabled>
                    ...
                    <input type="radio" name="tingkat_paham_lain_lain_dokter" value="Hal Baru"
                        id="tingkat_paham_lain_lain_baru" {{isset($edukasi_pasien_dokter->tingkat_paham_lain_lain_dokter) ? $edukasi_pasien_dokter->tingkat_paham_lain_lain_dokter=='Hal Baru' ? 'checked' : '' : ''}} disabled>
