<div class="container mt-5">
  <div class="card mt-5">
    <div class="card-header">
      <div class="row">
        <div class="col-md-9">
          <h3><b>RIWAYAT TRANSFER INTERNAL</b></h3>
        </div>
        <div class="col-md-3 float-right">
          <button class="btn btn-secondary" id="btnPrintTransferInternal"><i class="fas fa-print"></i> Print</button>
        </div>
      </div>
    </div>
    <div class="card-body">
      <div id="printTransferInternalContent">
        ...
        <table class="mt-3" style="width: 100%">
          <tbody>
            <tr>
              <td colspan="2" class="text-center noborder">Petugas Yang Menyerahkan</td>
              <td class="noborder"></td>
              <td colspan="2" class="text-center noborder">Petugas Yang Menerima</td>
            </tr>
