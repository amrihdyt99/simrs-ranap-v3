            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border-bottom: 1px solid black">
                        <input type="text" name="verif_keterangan_1" class="form-control"
                            value="{{ $pra_tindakan->verif_keterangan_1 }}">
                    </td>
                </tr>
                <tr>
                    <td>2</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_2_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_ruangan_2"
                                    {{ $pra_tindakan->verif_ruangan_2 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_2_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_ruangan_2"
                                    {{ $pra_tindakan->verif_ruangan_2 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_2_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_ruangan_2"
                                    {{ $pra_tindakan->verif_ruangan_2 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_2_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_cathlab_2"
                                    {{ $pra_tindakan->verif_cathlab_2 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_2_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_cathlab_2"
                                    {{ $pra_tindakan->verif_cathlab_2 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_2_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_cathlab_2"
                                    {{ $pra_tindakan->verif_cathlab_2 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text" name="verif_keterangan_2"
                            value="{{ $pra_tindakan->verif_keterangan_2 }}" class="form-control"></td>
                </tr>
                <tr>
                    <td>3</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_3_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_ruangan_3"
                                    {{ $pra_tindakan->verif_ruangan_3 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_3_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_ruangan_3"
                                    {{ $pra_tindakan->verif_ruangan_3 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_3_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_ruangan_3"
                                    {{ $pra_tindakan->verif_ruangan_3 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_3_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_cathlab_3"
                                    {{ $pra_tindakan->verif_cathlab_3 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_3_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_cathlab_3"
                                    {{ $pra_tindakan->verif_cathlab_3 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_3_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_cathlab_3"
                                    {{ $pra_tindakan->verif_cathlab_3 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text" name="verif_keterangan_3"
                            value="{{ $pra_tindakan->verif_keterangan_3 }}" class="form-control"></td>
                </tr>
                <tr>
                    <td>4</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_4_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_ruangan_4"
                                    {{ $pra_tindakan->verif_ruangan_4 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_4_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_ruangan_4"
                                    {{ $pra_tindakan->verif_ruangan_4 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_4_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_ruangan_4"
                                    {{ $pra_tindakan->verif_ruangan_4 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_4_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_cathlab_4"
                                    {{ $pra_tindakan->verif_cathlab_4 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_4_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_cathlab_4"
                                    {{ $pra_tindakan->verif_cathlab_4 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_4_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_cathlab_4"
                                    {{ $pra_tindakan->verif_cathlab_4 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text" name="verif_keterangan_4"
                            value="{{ $pra_tindakan->verif_keterangan_4 }}" class="form-control"></td>
                </tr>
                <tr>
                    <td>5</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_5_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_ruangan_5"
                                    {{ $pra_tindakan->verif_ruangan_5 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_5_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_ruangan_5"
                                    {{ $pra_tindakan->verif_ruangan_5 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_5_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_ruangan_5"
                                    {{ $pra_tindakan->verif_ruangan_5 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_5_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_cathlab_5"
                                    {{ $pra_tindakan->verif_cathlab_5 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_5_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_cathlab_5"
                                    {{ $pra_tindakan->verif_cathlab_5 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_5_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_cathlab_5"
                                    {{ $pra_tindakan->verif_cathlab_5 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text" name="verif_keterangan_5"
                            value="{{ $pra_tindakan->verif_keterangan_5 }}" class="form-control"></td>
                </tr>
                <tr>
                    <td>6</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_6_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_ruangan_6"
                                    {{ $pra_tindakan->verif_ruangan_6 == 'Tidak ada' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_6_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_ruangan_6"
                                    {{ $pra_tindakan->verif_ruangan_6 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_6_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_ruangan_6"
                                    {{ $pra_tindakan->verif_ruangan_6 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_6_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_cathlab_6"
                                    {{ $pra_tindakan->verif_cathlab_6 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_6_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_cathlab_6"
                                    {{ $pra_tindakan->verif_cathlab_6 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_6_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_cathlab_6"
                                    {{ $pra_tindakan->verif_cathlab_6 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text" name="verif_keterangan_6"
                            value="{{ $pra_tindakan->verif_keterangan_6 }}" class="form-control"></td>
                </tr>
                <tr>
                    <td>7</td>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_7_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_ruangan_7"
                                    {{ $pra_tindakan->verif_cathlab_6 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_7_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_ruangan_7"
                                    {{ $pra_tindakan->verif_cathlab_6 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_7_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_cathlab_7"
                                    {{ $pra_tindakan->verif_cathlab_7 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_7_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_cathlab_7"
                                    {{ $pra_tindakan->verif_cathlab_7 == 'Tidak ada' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_7_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_cathlab_7"
                                    {{ $pra_tindakan->verif_cathlab_7 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text" name="verif_keterangan_7"
                            value="{{ $pra_tindakan->verif_keterangan_7 }}" class="form-control"></td>
                </tr>
                <tr>
                    <td>8</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_8_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_ruangan_8"
                                    {{ $pra_tindakan->verif_ruangan_8 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_8_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_ruangan_8"
                                    {{ $pra_tindakan->verif_ruangan_8 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_ruangan_8_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_ruangan_8"
                                    {{ $pra_tindakan->verif_ruangan_8 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_8_1" type="radio" class="custom-control-input"
                                    value="Ya" name="verif_cathlab_8"
                                    {{ $pra_tindakan->verif_cathlab_8 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_8_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="verif_cathlab_8"
                                    {{ $pra_tindakan->verif_cathlab_8 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_verif_cathlab_8_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="verif_cathlab_8"
                                    {{ $pra_tindakan->verif_cathlab_8 == 'Tidak ada' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="input_verif_cathlab_8_3">Tidak ada</label>
                            </div>
                        </div>
                    </td>
                    <td style="border-bottom: 1px solid black"> <input type="text" name="verif_keterangan_8"
                            value="{{ $pra_tindakan->verif_keterangan_8 }}" class="form-control"></td>
                </tr>
                <tr>
                    <th style="width: 1px">No.</th>
                ...
                <tr>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_1_1" type="radio" class="custom-control-input"
                                    value="Ya" name="persiapan_ruangan_1"
                                    {{ $pra_tindakan->persiapan_ruangan_1 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_1_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="persiapan_ruangan_1"
                                    {{ $pra_tindakan->persiapan_ruangan_1 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_1_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="persiapan_ruangan_1"
                                    {{ $pra_tindakan->persiapan_ruangan_1 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_1_1" type="radio" class="custom-control-input"
                                    value="Ya" name="persiapan_cathlab_1"
                                    {{ $pra_tindakan->persiapan_cathlab_1 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_1_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="persiapan_cathlab_1"
                                    {{ $pra_tindakan->persiapan_cathlab_1 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_1_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="persiapan_cathlab_1"
                                    {{ $pra_tindakan->persiapan_cathlab_1 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text" name="persiapan_keterangan_1"
                            value="{{ $pra_tindakan->persiapan_keterangan_1 }}" class="form-control"></td>
                </tr>
                <tr>
                    <td>2</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_2_1" type="radio" class="custom-control-input"
                                    value="Ya" name="persiapan_ruangan_2"
                                    {{ $pra_tindakan->persiapan_ruangan_2 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_2_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="persiapan_ruangan_2"
                                    {{ $pra_tindakan->persiapan_ruangan_2 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_2_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="persiapan_ruangan_2"
                                    {{ $pra_tindakan->persiapan_ruangan_2 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_2_1" type="radio" class="custom-control-input"
                                    value="Ya" name="persiapan_cathlab_2"
                                    {{ $pra_tindakan->persiapan_cathlab_2 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_2_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="persiapan_cathlab_2"
                                    {{ $pra_tindakan->persiapan_cathlab_2 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_2_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="persiapan_cathlab_2"
                                    {{ $pra_tindakan->persiapan_cathlab_2 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text" name="persiapan_keterangan_2"
                            value="{{ $pra_tindakan->persiapan_keterangan_2 }}" class="form-control"></td>
                </tr>
                <tr>
                    <td>3</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_3_1" type="radio" class="custom-control-input"
                                    value="Ya" name="persiapan_ruangan_3"
                                    {{ $pra_tindakan->persiapan_ruangan_3 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_3_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="persiapan_ruangan_3"
                                    {{ $pra_tindakan->persiapan_ruangan_3 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_3_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="persiapan_ruangan_3"
                                    {{ $pra_tindakan->persiapan_ruangan_3 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_3_1" type="radio" class="custom-control-input"
                                    value="Ya" name="persiapan_cathlab_3"
                                    {{ $pra_tindakan->persiapan_cathlab_3 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_3_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="persiapan_cathlab_3"
                                    {{ $pra_tindakan->persiapan_cathlab_3 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_3_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="persiapan_cathlab_3"
                                    {{ $pra_tindakan->persiapan_cathlab_3 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text" name="persiapan_keterangan_3"
                            value="{{ $pra_tindakan->persiapan_keterangan_3 }}" class="form-control"></td>
                </tr>
                <tr>
                    <td>4</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_4_1" type="radio" class="custom-control-input"
                                    value="Ya" name="persiapan_ruangan_4"
                                    {{ $pra_tindakan->persiapan_ruangan_4 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_4_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="persiapan_ruangan_4"
                                    {{ $pra_tindakan->persiapan_ruangan_4 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_4_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="persiapan_ruangan_4"
                                    {{ $pra_tindakan->persiapan_ruangan_4 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_4_1" type="radio" class="custom-control-input"
                                    value="Ya" name="persiapan_cathlab_4"
                                    {{ $pra_tindakan->persiapan_cathlab_4 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_4_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="persiapan_cathlab_4"
                                    {{ $pra_tindakan->persiapan_cathlab_4 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_4_3" type="radio" class="custom-control-input"
                                    value="Tidak ada" name="persiapan_cathlab_4"
                                    {{ $pra_tindakan->persiapan_cathlab_4 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text" name="persiapan_keterangan_4"
                            value="{{ $pra_tindakan->persiapan_keterangan_4 }}" class="form-control"></td>
                </tr>
                <tr>
                    <td>5</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_5_1" type="radio" class="custom-control-input"
                                    value="Ya" name="persiapan_ruangan_5"
                                    {{ $pra_tindakan->persiapan_ruangan_5 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_5_2" type="radio" class="custom-control-input"
                                    value="Tidak" name="persiapan_ruangan_5"
                                    {{ $pra_tindakan->persiapan_ruangan_5 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_5_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_ruangan_5"
                                    {{ $pra_tindakan->persiapan_ruangan_5 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_5_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_cathlab_5"
                                    {{ $pra_tindakan->persiapan_cathlab_5 == 'Ya' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="input_persiapan_cathlab_5_1">Ya</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_5_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_cathlab_5"
                                    {{ $pra_tindakan->persiapan_cathlab_5 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_5_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_cathlab_5"
                                    {{ $pra_tindakan->persiapan_cathlab_5 == 'Tidak ada' ? 'checked' : '' }}>
                ...
                <tr>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_6_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_ruangan_6"
                                    {{ $pra_tindakan->persiapan_ruangan_6 == 'Ya' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="input_persiapan_ruangan_6_1">Ya</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_6_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_ruangan_6"
                                    {{ $pra_tindakan->persiapan_ruangan_6 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_6_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_ruangan_6"
                                    {{ $pra_tindakan->persiapan_ruangan_6 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_6_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_cathlab_6"
                                    {{ $pra_tindakan->persiapan_cathlab_6 == 'Ya' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="input_persiapan_cathlab_6_1">Ya</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_6_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_cathlab_6"
                                    {{ $pra_tindakan->persiapan_cathlab_6 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_6_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_cathlab_6"
                                    {{ $pra_tindakan->persiapan_cathlab_6 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black">
                        <input type="text" name="persiapan_keterangan_6" class="form-control"
                            value="{{ $pra_tindakan->persiapan_keterangan_6 }}">
                    </td>
                </tr>
                <tr>
                    <td>7</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_7_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_ruangan_7"
                                    {{ $pra_tindakan->persiapan_ruangan_7 == 'Ya' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="input_persiapan_ruangan_7_1">Ya</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_7_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_ruangan_7"
                                    {{ $pra_tindakan->persiapan_ruangan_7 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_7_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_ruangan_7"
                                    {{ $pra_tindakan->persiapan_ruangan_7 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_7_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_cathlab_7"
                                    {{ $pra_tindakan->persiapan_cathlab_7 == 'Ya' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="input_persiapan_cathlab_7_1">Ya</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_7_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_cathlab_7"
                                    {{ $pra_tindakan->persiapan_cathlab_7 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_7_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_cathlab_7"
                                    {{ $pra_tindakan->persiapan_cathlab_7 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black">
                        <input type="text" name="persiapan_keterangan_7" class="form-control"
                            value="{{ $pra_tindakan->persiapan_keterangan_7 }}">
                    </td>
                </tr>
                <tr>
                    <td>8</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_8_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_ruangan_8"
                                    {{ $pra_tindakan->persiapan_ruangan_8 == 'Ya' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="input_persiapan_ruangan_8_1">Ya</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_8_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_ruangan_8"
                                    {{ $pra_tindakan->persiapan_ruangan_8 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_8_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_ruangan_8"
                                    {{ $pra_tindakan->persiapan_ruangan_8 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_8_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_cathlab_8"
                                    {{ $pra_tindakan->persiapan_cathlab_8 == 'Ya' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="input_persiapan_cathlab_8_1">Ya</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_8_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_cathlab_8"
                                    {{ $pra_tindakan->persiapan_cathlab_8 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_8_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_cathlab_8"
                                    {{ $pra_tindakan->persiapan_cathlab_8 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text"
                            ...
                            value="{{ $pra_tindakan->persiapan_keterangan_8 }}"></td>
                </tr>
                <tr>
                    <td>9</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_9_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_ruangan_9"
                                    {{ $pra_tindakan->persiapan_ruangan_9 == 'Ya' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="input_persiapan_ruangan_9_1">Ya</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_9_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_ruangan_9"
                                    {{ $pra_tindakan->persiapan_ruangan_9 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_9_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_ruangan_9"
                                    {{ $pra_tindakan->persiapan_ruangan_9 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_9_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_cathlab_9"
                                    {{ $pra_tindakan->persiapan_ruangan_9 == 'Ya' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="input_persiapan_cathlab_9_1">Ya</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_9_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_cathlab_9"
                                    {{ $pra_tindakan->persiapan_ruangan_9 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_9_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_cathlab_9"
                                    {{ $pra_tindakan->persiapan_ruangan_9 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text"
                            ...
                            value="{{ $pra_tindakan->persiapan_keterangan_9 }}"></td>
                </tr>
                <tr>
                    <td>10</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_10_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_ruangan_10"
                                    {{ $pra_tindakan->persiapan_ruangan_10 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_10_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_ruangan_10"
                                    {{ $pra_tindakan->persiapan_ruangan_10 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_10_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_ruangan_10"
                                    {{ $pra_tindakan->persiapan_ruangan_10 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_10_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_cathlab_10"
                                    {{ $pra_tindakan->persiapan_cathlab_10 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_10_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_cathlab_10"
                                    {{ $pra_tindakan->persiapan_cathlab_10 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_10_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_cathlab_10"
                                    {{ $pra_tindakan->persiapan_cathlab_10 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text"
                            ...
                            value="{{ $pra_tindakan->persiapan_keterangan_10 }}"></td>
                </tr>
                <tr>
                    <td>11</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_11_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_ruangan_11"
                                    {{ $pra_tindakan->persiapan_ruangan_11 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_11_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_ruangan_11"
                                    {{ $pra_tindakan->persiapan_ruangan_11 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_11_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_ruangan_11"
                                    {{ $pra_tindakan->persiapan_ruangan_11 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_11_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_cathlab_11"
                                    {{ $pra_tindakan->persiapan_cathlab_11 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_11_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_cathlab_11"
                                    {{ $pra_tindakan->persiapan_cathlab_11 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_11_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_cathlab_11"
                                    {{ $pra_tindakan->persiapan_cathlab_11 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text"
                            name="persiapan_keterangan_11" class="form-control"
                            value="{{ $pra_tindakan->persiapan_keterangan_11 }}"></td>
                </tr>
                <tr>
                    <td>12</td>
                    <td>Lain-lain**</td>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_12_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_ruangan_12"
                                    {{ $pra_tindakan->persiapan_ruangan_12 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_12_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_ruangan_12"
                                    {{ $pra_tindakan->persiapan_ruangan_12 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_ruangan_12_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_ruangan_12"
                                    {{ $pra_tindakan->persiapan_ruangan_12 == 'Tidak ada' ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_12_1" type="radio"
                                    class="custom-control-input" value="Ya" name="persiapan_cathlab_12"
                                    {{ $pra_tindakan->persiapan_cathlab_11 == 'Ya' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_12_2" type="radio"
                                    class="custom-control-input" value="Tidak" name="persiapan_cathlab_12"
                                    {{ $pra_tindakan->persiapan_ruangan_12 == 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="input_persiapan_cathlab_12_3" type="radio"
                                    class="custom-control-input" value="Tidak ada" name="persiapan_cathlab_12"
                                    {{ $pra_tindakan->persiapan_ruangan_12 == 'Tidak ada' ? 'checked' : '' }}>
                    ...
                    <td style="border-bottom: 1px solid black"> <input type="text"
                            name="persiapan_keterangan_12" class="form-control"
                            value="{{ $pra_tindakan->persiapan_keterangan_12 }}"></td>
                </tr>
            </tbody>
        </table>
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" name="tgl_jam_ruangan"
                                value="{{ $pra_tindakan->tgl_jam_ruangan }}">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label>Perawat Ruangan</label>
                            <input type="text" class="form-control" name="perawat_ruangan"
                                value="{{ $pra_tindakan->perawat_ruangan }}">
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="form-group">
                            <label>Tanggal dan Jam </label>
                            <input type="datetime-local" class="form-control" name="tgl_jam_cathlab"
                                value="{{ $pra_tindakan->tgl_jam_cathlab }}">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label>Perawat Cathlab</label>
                            <input type="text" class="form-control" name="perawat_cathlab"
                                value="{{ $pra_tindakan->perawat_cathlab }}">
                        </div>
                    </td>
                </tr>
            </tbody>
