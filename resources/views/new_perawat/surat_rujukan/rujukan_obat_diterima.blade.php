@php
$judul_form = 'Obat/cairan yang diterima pada saat transfer';
$url_form = route('nyaa_universal.view_injector_support.perawat.nyaa_surat_rujukan',[3]);
@endphp
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-sm-12 pb-3" style>
                <button type="button" class="protecc btn btn-sm btn-info" onclick="nyaa_act(this,'ModalBase_orig_surat_rujukan_obat_terima','ModalBase')" nyaa-mode="add">Tambah Data Baru</button>
            </div>
            <div class="col-sm-12">
                <div class="w-100">
        ...
        <div id="ModalBase_orig_surat_rujukan_obat_terima" style="display:none!important;">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-sm-12">
                                                ...
                                                <input nyaatempname="item_id_terima" autocomplete="off" type="text" class="form-control">
                                            </div>
                                        </div>
