...
$url_form = route('nyaa_universal.view_injector_support.perawat.nyaa_surat_rujukan',[5]);
@endphp
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-sm-12 pb-3" style>
                <button type="button" class="protecc btn btn-sm btn-info" onclick="nyaa_act(this,'ModalBase_orig_suratrujukan_sttsps','ModalBase')" nyaa-mode="add">Tambah Data Baru</button>
            </div>
            <div class="col-sm-12">
                <div class="w-100">
                <table id="dttb_surat_rujukan5" nyaa-urldatatable="{{ $url_form }}" 
                nyaa-columns='[
                    {"data": "id", "name": "id"},
        ...
        <div id="ModalBase_orig_suratrujukan_sttsps" style="display:none!important;">
