<div class="modal fade" id="resikoJatuhDetailModalHumptyDumpty" tabindex="-1" role="dialog" aria-labelledby="resikoJatuhDetailModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="resikoJatuhDetailModalLabelHumptyDumpty">Detail Risiko Jatuh</h5>
            ...
            <div class="modal-body">
                    ...
                    <table class="table1" id="detail_resiko_jatuh_humpty_dumpty">
                        <tbody>
                            <tr>
                                <td>Umur</td>
                                <td>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="umur_3thn" name="humpty_dumpty_umur" value="4">
                                        <label for="umur_3thn">a. &lt; 3 tahun</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="umur_3-6thn" name="humpty_dumpty_umur" value="3">
                                        <label for="umur_3-6thn">b. 3-6 tahun</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="umur_7-13thn" name="humpty_dumpty_umur" value="2">
                                        <label for="umur_7-13thn">c. 7-13 tahun</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="umur_13thn" name="humpty_dumpty_umur" value="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="laki_laki" name="humpty_dumpty_jenis_kelamin" value="2">
                                        <label for="laki_laki">a. Laki-laki</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="perempuan" name="humpty_dumpty_jenis_kelamin" value="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="diagnosa_neurologi" name="humpty_dumpty_diagnosis" value="4">
                                        <label for="diagnosa_neurologi">a. Diagnosa neurologi</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="diagonosi_gangguan" name="humpty_dumpty_diagnosis" value="3">
                                        <label for="diagonosi_gangguan">b. Gangguan oksigenisasi</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="diagnosis_perilaku" name="humpty_dumpty_diagnosis" value="2">
                                        <label for="diagnosis_perilaku">c. Gangguan perilaku/jiwa</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="diagnosis_lain" name="humpty_dumpty_diagnosis" value="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="tidak_waspada" name="humpty_dumpty_gangguan_kognitif" value="3">
                                        <label for="tidak_waspada">a. Tidak waspada terhadap keterbatasan</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="lupa_keterbatasan" name="humpty_dumpty_gangguan_kognitif"
                                            value="2">
                                        <label for="lupa_keterbatasan">b. Lupa akan keterbatasannya</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="berorientasi_diri" name="humpty_dumpty_gangguan_kognitif"
                                            value="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="riwayat_jatuh_tidur" name="humpty_dumpty_faktor_lingkungan"
                                            value="4">
                                        <label for="riwayat_jatuh_tidur">a. Riwayat jatuh/bayi/anak-anak berada di tempat
                                            tidur dewasa</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="menggunakan_alat_bantu" name="humpty_dumpty_faktor_lingkungan"
                                            value="3">
                                        <label for="menggunakan_alat_bantu">b. Pasien menggunakan alat bantu</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="berada_tempat_tidur" name="humpty_dumpty_faktor_lingkungan"
                                            value="2">
                                        <label for="berada_tempat_tidur">c. Pasien berada di tempat tidur</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="area_rajal" name="humpty_dumpty_faktor_lingkungan" value="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="24jam" name="humpty_dumpty_respon_terhadap_anastesi"
                                            value="3">
                                        <label for="24jam">a. Dalam 24 jam</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="48jam" name="humpty_dumpty_respon_terhadap_anastesi"
                                            value="2">
                                        <label for="48jam">b. Dalam 48 jam</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="lebih48jam" name="humpty_dumpty_respon_terhadap_anastesi"
                                            value="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="obat_risiko_tinggi_ya" name="humpty_dumpty_gangguan_obat"
                                            value="3">
                                        <label for="obat_risiko_tinggi_ya">a. Penggunaan: Sedatives, Hypnotics, Laxatives,
                                            Diuretics, Narcotics</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="obat_risiko_tinggi_tidak" name="humpty_dumpty_gangguan_obat"
                                            value="2">
                                        <label for="obat_risiko_tinggi_tidak">b. Satu dari obat tersebut di atas</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="obat_risiko_tinggi_lain" name="humpty_dumpty_gangguan_obat"
                                            value="1">
                            ...
                            <tr>
                                <td colspan="2">Total Skor Risiko Jatuh Humpty Dumpty :</td>
                                <td>
                                    <label id="total_skor_humpty_dumpty_detail"></label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="kategori_rendah_humpty_dumpty" name="kategori_humpty_dumpty"
                                            value="Resiko Rendah">
                                        <label for="kategori_rendah_humpty_dumpty">Resiko Rendah / RR (0-1)</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="kategori_sedang_humpty_dumpty" name="kategori_humpty_dumpty"
                                            value="Resiko Sedang">
                                        <label for="kategori_sedang_humpty_dumpty">Resiko Sedang / RS (2-3)</label>
                                    </div>
                                    <div class="radio-container">
                                        <input type="radio" disabled id="kategori_tinggi_humpty_dumpty" name="kategori_humpty_dumpty"
                                            value="Resiko Tinggi">
                    ...
                    <table class="table1 w-100" id="detail_resiko_jatuh_humpty_dumpty2">
                        <!-- Risiko Rendah -->
                        <tr>
                            <td rowspan="14">
                            ...
                            <td>
                                <input type="checkbox" disabled name="intervensi_resiko_jatuh_humpty_dumpty_rendah[]"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" disabled name="intervensi_resiko_jatuh_humpty_dumpty_tinggi[]"
