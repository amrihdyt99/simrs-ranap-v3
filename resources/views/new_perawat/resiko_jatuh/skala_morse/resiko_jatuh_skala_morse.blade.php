<div class="container">
    <div class="card card-primary">
        <h3 class="card-title mt-3 ml-3">PENGKAJIAN RESIKO JATUH SKALA MORSE</h3>
        <div class="d-flex justify-content-end">
            <button type="button" class="btn btn-info mr-5" data-toggle="modal" data-target="#resikoJatuhModalSkalaMorse">
                History
            </button>
        </div>
        <form id="entry-resiko-jatuh-skala-morse">
            @csrf
            <div id="body-form" class="card-body">
                <div class="card-header">
                    <h3 class="text-black">Penilaian Risiko Jatuh Pasien Skala Morse</h3>
                </div>
                <table class="table1" id="morse_table">
                    <tbody>
                        <tr>
                            <td>Riwayat Jatuh</td>
                        ...
                        <tr>
                            <td colspan="4"><b>Total Skor Risiko Jatuh Pasien Dewasa Hall Morse Scale : <label
                                        id="resiko_jatuh_morse_total_skor"></label></b>
                            </td>
                        </tr>
                        <tr>
                ...
                <table class="table1 w-100">
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" name="intervensi_resiko_jatuh_skala_morse_rendah[]"
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" name="intervensi_resiko_jatuh_skala_morse_sedang[]"
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" name="intervensi_resiko_jatuh_skala_morse_tinggi[]"
                ...
                <div class="card-footer">
                    <button type="button" class="btn btn-primary"
                        onclick="addresikojatuhSkalaMorse()">Simpan</button>
                </div>
            </div>
        </form>
    </div>
...
<script>
    function hitungMorse() {
        ...
        $("#morse_table input[type='radio']:checked").each(function() {
            let value = $(this).val();
        ...
        $("#resiko_jatuh_morse_total_skor").text(totalScore);

        if (totalScore >= 4) {
            $("#kategori_tinggi_morse").prop("checked", true);
        } else if (totalScore >= 2) {
            $("#kategori_sedang_morse").prop("checked", true);
        } else {
            $("#kategori_rendah_morse").prop("checked", true);
        }
    }

    $("#morse_table input[type='radio']").on("change", function() {
        hitungMorse();
    });
</script>

@include('new_perawat.resiko_jatuh.skala_morse.history_resiko_jatuh_skala_morse')
@include('new_perawat.resiko_jatuh.skala_morse.detail_history_resiko_jatuh_skala_morse')
