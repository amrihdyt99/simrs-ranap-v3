...
<div class="form-group row ">
    ...
    <div class="input-group col-sm-10">
        <input id="darah" type="number" class="form-control" name="asper_tekanan_darah" value="{{$pengkajian_awal->tekanan_darah}}">
    </div>
</div>
<div class="form-group row ">
    <label for="inputPassword3" class="col-sm-2 col-form-label">Nadi</label>
    <div class="input-group col-sm-10">
        <input id="nadi" type="number" class="form-control" name="asper_nadi" value="{{$pengkajian_awal->nadi}}">
    </div>
</div>
<div class="form-group row ">
    <label for="inputPassword3" class="col-sm-2 col-form-label">Suhu</label>
    <div class="input-group col-sm-10">
        <input id="suhu" type="number" class="form-control" name="asper_suhu" value="{{$pengkajian_awal->suhu}}">
    </div>
</div>
<div class="form-group row ">
    <label for="inputPassword3" class="col-sm-2 col-form-label">Pernapasan</label>
    <div class="input-group col-sm-10">
        <input id="napas" type="number" class="form-control" name="asper_pernapasan" value="{{$pengkajian_awal->penafasan}}">
    </div>
</div>
<div class="form-group row ">
    <label for="inputPassword3" class="col-sm-2 col-form-label">Tinggi Badan</label>
    <div class="input-group col-sm-10">
        <input id="t-badan" type="number" class="form-control" name="asper_tinggi_bdn" value="{{$pengkajian_awal->tinggi_badan}}">
    </div>
</div>
<div class="form-group row ">
    <label for="inputPassword3" class="col-sm-2 col-form-label">Berat Badan</label>
    <div class="input-group col-sm-10">
        <input id="b-badan" type="number" class="form-control" name="asper_berat_badan" value="{{$pengkajian_awal->berat_badan}}">
    </div>
</div>
<div class="form-group row ">
    <label for="inputPassword3" class="col-sm-2 col-form-label">HPHT</label>
    <div class="input-group col-sm-10">
        <input id="hpht" type="number" class="form-control" name="asper_hpht" value="{{$pengkajian_awal->asper_hpht}}">
    </div>
</div>
<div class="form-group row ">
    <label for="inputPassword3" class="col-sm-2 col-form-label">TP</label>
    <div class="input-group col-sm-10">
        <input id="tp" type="number" class="form-control" name="asper_tp" value="{{$pengkajian_awal->asper_tp}}">
    </div>
</div>
...
<fieldset class="form-group">
    <div class="header">
        <h4>Skrining Risiko Cedera / Jatuh</h4>
        <div class="row">
...
<fieldset class="form-group">
    <div class="header">
        <h4>Kebutuhan Nutrisi dan Cairan</h4>
        @php
...
<fieldset class="form-group">
    <div class="header">
        <h4>Data Psikologis, Sosial, Ekonomi dan Spiritual</h4>
        <div class="row">
