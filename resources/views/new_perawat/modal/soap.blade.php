                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="subject" rows="10" name="soaper_subject"
                                    @if(auth()->user()->level_user == 'dietitian' || auth()->user()->level_user == 'farmasi') readonly @endif></textarea>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="object" rows="10" name="soaper_object"
                                    @if(auth()->user()->level_user == 'dietitian' || auth()->user()->level_user == 'farmasi') readonly @endif></textarea>
                            </div>
                        </div>
                        <div class="col-lg-3">
