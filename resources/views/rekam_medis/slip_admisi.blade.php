...
<body>
    <table width="1002" border="1" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td width="998" align="center"><img src="{{asset('new_assets/images/kop.png')}}" alt="" width="1051" height="178" /><br />      <table width="1060" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                    ...
                    <tr>
                        <td colspan="10" align="center" valign="middle"><table width="83%" border="1" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                    ...
                    <tr>
                        ...
                        <td>:   @if($datapasien->reg_ketersidaan_kamar == 1)
                                Ya
                            @else
                                Tidak
                            @endif</td>
