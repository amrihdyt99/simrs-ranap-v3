    ...
    <div class="card card-default">
        <form action="{{route('store.cpoe.laboratory')}}" method="POST">
            ...
            <div class="card-header">
                <label for="" class="text-sm card-title">CPOE Laboratory</label>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <strong class="text-sm">HEMATOLOGI</strong>
                            ...
                            <div class="card-body">
                                @foreach($cpoe_labor as $labor)
                                    @if($labor->kategori === 'hematologi')
                                        <div class="form-check">
                                            <input type="checkbox"
                                                   class="form-check-input" name="cpoe_laboratory_id[]"
                                                   value="{{$labor->id}}">
                                            <label
                                                class="form-check-label text-sm">{{$labor->nama}}</label>
                                        </div>
                                    @endif
                                @endforeach
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <strong class="text-sm">SEROLOGI - IMUNOLOGI</strong>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool"
                                            data-card-widget="collapse">
                                        <i class="fas fa-minus"></i>
                            ...
                            <div class="card-body">
                                @foreach($cpoe_labor as $labor)
                                    @if($labor->kategori === 'serologi-imunologi')
                                        <div class="form-check">
                                            <input type="checkbox"
                                                   class="form-check-input" name="cpoe_laboratory_id[]"
                                                   value="{{$labor->id}}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <strong class="text-sm">URINALISIS</strong>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool"
                                            data-card-widget="collapse">
                                        <i class="fas fa-minus"></i>
                    ...
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <strong class="text-sm">MIKROBIOLOGI</strong>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool"
                                            data-card-widget="collapse">
                                        <i class="fas fa-minus"></i>
                            ...
                            <div class="card-body">
                                @foreach($cpoe_labor as $labor)
                                    @if($labor->kategori === 'mikrobiologi')
                                        <div class="form-check">
                                            <input type="checkbox"
                                                   class="form-check-input" name="cpoe_laboratory_id[]"
                                                   value="{{$labor->id}}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <strong class="text-sm">FESES</strong>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool"
                                            data-card-widget="collapse">
                                        <i class="fas fa-minus"></i>
                    ...
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <strong class="text-sm">ANALISA CAIRAN TUBUH</strong>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool"
                                            data-card-widget="collapse">
                                        <i class="fas fa-minus"></i>
                            ...
                            <div class="card-body">
                                @foreach($cpoe_labor as $labor)
                                    @if($labor->kategori === 'analisa cairan tubuh')
                                        <div class="form-check">
                                            <input type="checkbox"
                                                   class="form-check-input" name="cpoe_laboratory_id[]"
                                                   value="{{$labor->id}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <strong class="text-sm">KIMIA KLINIK</strong>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool"
                                            data-card-widget="collapse">
                                        <i class="fas fa-minus"></i>
                            ...
                            <div class="card-body">
                                @foreach($cpoe_labor as $labor)
                                    @if($labor->kategori === 'kimia klinik')
                                        <div class="form-check">
                                            <input type="checkbox"
                                                   class="form-check-input" name="cpoe_laboratory_id[]"
                                                   value="{{$labor->id}}">
