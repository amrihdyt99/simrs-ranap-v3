<h3><b>SURAT RUJUKAN</b></h3>
    <div>
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="prosedur_operasi-tab" data-toggle="tab" href="#prosedur_operasi" role="tab" aria-controls="prosedur_operasi-tab" aria-selected="false">
                    Prosedur/Operasi</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link " id="obat_diterima-tab" data-toggle="tab" href="#obat_diterima" role="tab" aria-controls="obat_diterima-tab" aria-selected="false">
                    Obat Yang Diterima</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="obat_dibawa-tab" data-toggle="tab" href="#obat_dibawa" role="tab" aria-controls="obat_dibawa-tab" aria-selected="false">
