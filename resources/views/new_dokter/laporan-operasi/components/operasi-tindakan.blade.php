    ...
    <form action="{{ route('dokter.laporan-operasistore.rencana-operasi-tindakan', $reg) }}" id="form-rencana-operasi-tindakan" method="post">
            ...
            <div class="col-sm-12 col-lg-4">
                <div class="form-group">
                    ...
                    <select name="tipe_operasi" id="tipe_operasi" class="form-control">
                        ...
                        <option value="Darurat" {{ $data['operasi_tindakan']->tipe_operasi == 'Daruat' ? 'selected':'' }}>Darurat</option>
                        <option value="Terencana"  {{ $data['operasi_tindakan']->tipe_operasi == 'Terencana' ? 'selected':'' }}>Terencana</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="tipe_anestesi" id="tipe_anestesi" class="form-control">
                ...
                <option value="Spinal" {{ $data['operasi_tindakan']->tipe_anestesi == 'Spinal' ? 'selected' : '' }}>Spinal</option>
                <option value="Epidural" {{ $data['operasi_tindakan']->tipe_anestesi == 'Epidural' ? 'selected': '' }}>Epidural</option>
                <option value="GA" {{ $data['operasi_tindakan']->tipe_anestesi == 'GA' ? 'selected': '' }}>GA</option>
                <option value="Peripheral" {{ $data['operasi_tindakan']->tipe_anestesi == 'Peripheral' ? 'selected': '' }}>Peripheral</option>
                <option value="Local" {{ $data['operasi_tindakan']->tipe_anestesi == 'Local' ? 'selected' : ''}}>Local</option>
            </select>
        </div>
        <hr/>
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-2">
                    <select name="pengirim_spesimen_klinik_patologi" id="pengirim-spesimen-klinik-patologi" class="form-control">
                        ...
                        <option value="1" {{ $data['operasi_tindakan']->pengirim_spesimen_klinik_patologi == '1' ? 'selected': '' }}>Ya</option>
                        <option value="0" {{ $data['operasi_tindakan']->pengirim_spesimen_klinik_patologi == '0' ? 'selected': '' }}>Tidak</option>
                    </select>
                </div>
                <div class="col-sm-12 col-lg-10 row">
                    <div class="col-sm-12 col-lg-2">
                        <input type="radio" name="ket_spesimen_klinik_patologi" id="ket_spesimen_klinik_patologi1" 
                            value="Jaringan" {{ $data['operasi_tindakan']->ket_spesimen_klinik_patologi == 'Jaringan' ? 'checked':'' }}>
                    ...
                    <div class="col-sm-12 col-lg-2">
                        <input type="radio" name="ket_spesimen_klinik_patologi" id="ket_spesimen_klinik_patologi2" 
                            value="Batu" {{ $data['operasi_tindakan']->ket_spesimen_klinik_patologi == 'Batu' ? 'checked':'' }}>
                    ...
                    <div class="col-sm-12 col-lg-2">
                        <input type="radio" name="ket_spesimen_klinik_patologi" id="ket_spesimen_klinik_patologi3" 
                            value="Pus" {{ $data['operasi_tindakan']->ket_spesimen_klinik_patologi == 'Pus' ? 'checked':'' }}>
                    ...
                    <div class="col-sm-12 col-lg-2">
                        <input type="radio" name="ket_spesimen_klinik_patologi" id="ket_spesimen_klinik_patologi4" 
                            value="Lainnya" {{ $data['operasi_tindakan']->ket_spesimen_klinik_patologi == 'Lainnya' ? 'checked':'' }}>
            ...
            <div class="col-sm-12 col-lg-3">
                <div class="form-group">
                    ...
                    <select name="kultur" id="kultur" class="form-control">
                        ...
                        <option value="1" {{ $data['operasi_tindakan']->kultur == '1' ? 'selected':'' }}>Ya</option>
                        <option value="0" {{ $data['operasi_tindakan']->kultur == '0' ? 'selected':'' }}>Tidak</option>
                    </select>
                </div>
            </div>
        </div>
