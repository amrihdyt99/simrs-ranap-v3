        ...
        <div class="card-body">
            ...
            <table class="table1" style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <input type="text" name="penolakan_nama_1" id="penolakan_nama_1" class="form-control" value="">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="radio" name="penolakan_jenis_kelamin_1" id="penolakan_jenis_kelamin_1_laki" value="Laki-laki">
                        <label for="penolakan_jenis_kelamin_1_laki">Laki-laki</label>
                        <input type="radio" name="penolakan_jenis_kelamin_1" id="penolakan_jenis_kelamin_1_perempuan" value="Perempuan">
                ...
                <tr>
                    ...
                    <td>
                        <input type="date" name="penolakan_tanggal_lahir_1" id="penolakan_tanggal_lahir_1" class="form-control" value="">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="penolakan_alamat_1" id="penolakan_alamat_1" class="form-control" value="">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="penolakan_pernyataan" id="penolakan_pernyataan" class="form-control" value="">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="penolakan_nama_2" id="penolakan_nama_2" class="form-control" value="">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="radio" name="penolakan_jenis_kelamin_2" id="penolakan_jenis_kelamin_2_laki" value="Laki-laki">
                        <label for="penolakan_jenis_kelamin_2_laki">Laki-laki</label>
                        <input type="radio" name="penolakan_jenis_kelamin_2" id="penolakan_jenis_kelamin_2_perempuan" value="Perempuan">
                ...
                <tr>
                    ...
                    <td>
                        <input type="date" name="penolakan_tanggal_lahir_2" id="penolakan_tanggal_lahir_2" class="form-control" value="">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="penolakan_alamat_2" id="penolakan_alamat_2" class="form-control" value="">
                    </td>
                </tr>
            </table>
                        ...
                        <div style="display: flex; flex-direction: column; align-items: center;">
                            ...
                            <div id="signature-pad-penolakan-penerima" style="display: inline-block;">
                                <div style="border: solid 1px teal; width: 260px; height: 160px; position: relative;">
                                    <canvas id="canvas_penolakan_penerima" width="260" height="160">Your browser does not support the HTML canvas tag.</canvas>
                                </div>
                                <div style="margin: 10px; text-align: center;">
                                    <input type="hidden" id="signature_penolakan_penerima" name="penolakan_ttd_yg_menyatakan" value="">
                                    <button type="button" id="clear_btn_penolakan_penerima" class="btn btn-danger" data-action="clear"><span class="glyphicon glyphicon-remove"></span> Hapus</button>
                                    <input type="text" name="nama_penolakan_penerima" id="nama_penolakan_penerima" class="form-control mt-2" placeholder="Nama Yang Menyatakan">
                                </div>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div style="display: flex; flex-direction: column; align-items: center;">
                            ...
                            <div id="signature-pad-penolakan-dokter" style="display: inline-block;">
                                <div style="border: solid 1px teal; width: 260px; height: 160px; position: relative;">
                                    <canvas id="canvas_penolakan_dokter" width="260" height="160">Your browser does not support the HTML canvas tag.</canvas>
                                </div>
                                <div style="margin: 10px; text-align: center;">
                                    <input type="hidden" id="signature_penolakan_dokter" name="penolakan_ttd_dokter" value="">
                                    <button type="button" id="clear_btn_penolakan_dokter" class="btn btn-danger" data-action="clear"><span class="glyphicon glyphicon-remove"></span> Hapus</button>
                                    <input type="text" name="nama_penolakan_dokter" id="nama_penolakan_dokter" class="form-control mt-2" placeholder="Nama Dokter" value="">
                                </div>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <div style="display: flex; flex-direction: column; align-items: center;">
                            ...
                            <div id="signature-pad-penolakan-keluarga" style="display: inline-block;">
                                <div style="border: solid 1px teal; width: 260px; height: 160px; position: relative;">
                                    <canvas id="canvas_penolakan_keluarga" width="260" height="160">Your browser does not support the HTML canvas tag.</canvas>
                                </div>
                                <div style="margin: 10px; text-align: center;">
                    ...
                    <td>
                        <div style="display: flex; flex-direction: column; align-items: center;">
                            ...
                            <div id="signature-pad-penolakan-perawat" style="display: inline-block;">
                                <div style="border: solid 1px teal; width: 260px; height: 160px; position: relative;">
                                    <canvas id="canvas_penolakan_perawat" width="260" height="160">Your browser does not support the HTML canvas tag.</canvas>
                                </div>
                                <div style="margin: 10px; text-align: center;">
                                    <input type="hidden" id="signature_penolakan_perawat" name="penolakan_ttd_perawat" value="">
                                    <button type="button" id="clear_btn_penolakan_perawat" class="btn btn-danger" data-action="clear"><span class="glyphicon glyphicon-remove"></span> Hapus</button>
                                    <input type="text" name="nama_penolakan_perawat" id="nama_penolakan_perawat" class="form-control mt-2" placeholder="Nama Perawat" value="">
                                </div>
                            </div>
                        </div>
                    </td>
