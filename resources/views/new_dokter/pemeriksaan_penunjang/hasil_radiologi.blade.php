...
<head>
    ...
    <meta name="csrf-token" content="Q5jBUDi4KbHAGrHgZ0HTpnfVcKAtHOhFWyj5s0K4">
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="border-custom">
                <div class="row pt-2 pl-2 pr-2 font-weight-bold">
                    ...
                    <div class="col-sm-4">
                        <div id="patient_name">: {{$jsonDecode->data->patient_information->patient_name}}</div>
                    </div>
                    <div class="col-sm-2">
                        <div>Pemeriksaan</div>
                    </div>
                    <div class="col-sm-4">
                        <div id="pemeriksaan">: {{$jsonDecode->data->result->item_name}}</div>
                    </div>
                </div>
                <div class="row pl-2 pr-2 font-weight-bold">
                    ...
                    <div class="col-sm-4">
                        <div id="patient_birth_dttm">: {{$jsonDecode->data->patient_information->born}}</div>
                    </div>
                    <div class="col-sm-2">
                        <div>No. RM</div>
                    </div>
                    <div class="col-sm-4">
                        <div id="patient_id">: {{$jsonDecode->data->patient_information->medical_no}}</div>
                    </div>
                </div>
                <div class="row pl-2 pr-2 font-weight-bold">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                        <div id="patient_sex">: {{$jsonDecode->data->patient_information->gender}}</div>
                    </div>
                </div>
                <div class="row pl-2 pr-2 font-weight-bold">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                        <div id="approve_dttm">: {{$jsonDecode->data->result->create_datetime}}</div>
                    </div>
                    <div class="col-sm-2">
                        <div>Klinis</div>
                    </div>
                    <div class="col-sm-4">
                        <div id="diagnosis">: {{$jsonDecode->data->result->remarks}}</div>
                    </div>
                </div>
                <div class="row pb-2 pl-2 pr-2 font-weight-bold">
                    ...
                    <div class="col-sm-4">
                        <div>: {{$jsonDecode->data->patient_information->patient_name}}</div>
                    </div>
                </div>
            </div>
            <div class="row pt-2 pb-2 pl-2 pr-2">
                ...
                <div class="col-sm-12 pt-3 request-name">
                    Deskripsi : {{$jsonDecode->data->result->item_name}}
                </div>
            </div>
            <div class="row pb-2 pl-2 pr-2">
                <div class="col-sm-12 pt-3 report-text">
                    ...
                    - Tak tampak opasitas patologis pada cavum abdomen maupun pelvis
...
<script>
    ...
    let report_text = "X FOTO POLOS ABDOMEN AP SUPINE\r\n\r\n- Tak tampak opasitas patologis pada cavum abdomen maupun pelvis\r\n- Preperitoneal fat line kanan kiri baik\r\n- Psoas line kanan kiri dan kontur kedua ginjal baik\r\n- Jumlah dan distribusi udara usus normal\r\n- Tak tampak distensi maupun dilatasi loop-loop usus\r\n- Tak tampak gambaran coiled spring maupun herring bone\r\n- Tampak banyak fekal material\r\n- Tak tampak free air\r";
    let conclusion = "\nKESAN : Test SIMRS BARU RME";
