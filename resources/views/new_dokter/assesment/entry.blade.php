    ...
    $cek = DB::connection('mysql')
            ->table('assesment_awal_dokter')->where('no_reg',$reg);
...
<div class="text-black" style="font-size: 14px">
   ...
   <hr>
    ...
    <div class="form-group row">
        ...
        <div class="form-group row">
            <div class="col-sm-12">
                <h2 class="exampleFormControlTextarea1">Pemeriksaan Multi Organ</h2 class="exampleFormControlTextarea1">
...
<div class="text-black" style="font-size: 14px">
    <h2 class="text-black">Pengkajian Awal Rawat Inap</h2>
<h6>assesment terakhir : <span id="last-asses" class="font-weight-bold">{{app(\App\Http\Controllers\ZxcNyaaUniversal\UniversalFunctionController::class)->carbon_format_day_date_id($cek->first()->created_at)}} [ {{date('H:i:s',strtotime($cek->first()->created_at))}} ]</span></h6>
<hr>
@php
$data = $cek->first();
@endphp
