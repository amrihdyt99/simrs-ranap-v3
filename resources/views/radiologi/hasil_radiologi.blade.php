                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%">
                            <img src="{{ asset('new_assets\images\sumsel.png') }}" width="70" height="95" alt="" srcset="" />
                        </div>
                    </div>
                    ...
                    <div class="col-sm-2">
                        <div class="d-flex justify-content-center align-items-center" style="height: 100%">
                            <img src="{{ asset('new_assets\images\icon.png') }}" width="80" height="80" alt=""
                                srcset="">
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function openExternalViewer() {
            if (fileUrl) {
                ...
                alert('Hasil Pemeriksaan Radiologi tidak tersedia');
            }
        }
        $(document).ready(function() {
            $('.report-text').html(report_text.replaceAll('\n', '<br>'));
            $('.conclusion').html(conclusion.replaceAll('\n', '<br>'));
            const openFileButton = $('<button>')
                .text('Buka File Radiologi')
                .addClass('btn btn-outline-secondary mt-3 print-hide')
                .on('click', function() {
                    openExternalViewer();
                    $(this).hide();
                })
