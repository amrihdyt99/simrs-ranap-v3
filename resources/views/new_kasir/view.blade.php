...
<style>
    ...
    .table-r thead, .table-r .r-service-cat {
    ...
    #pay-method ::placeholder { /* Chrome, Firefox, Opera, Safari 10.1+ */
        ...
        <div class="col-lg-2 pr-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <h6>Diagnosa</h6>
                        <h3 id="bill_diagnosis">-</h3>
                    </div>
                    <div class="form-group">
                        <h6>Jenis Kunjungan</h6>
                        <h3 id="bill_jenis_kunj">-</h3>
                    </div>
                    <div class="form-group">
                        <h6>Payer</h6>
                        <h3 id="bill_payer">-</h3>
                    ...
                    <div id="panel-ppoli">
                        <div class="row">
                            <div class="col">
                                ...
                                <button class="btn btn-primary text-right mb-3" id="btn-add-item"><i class="fas fa-plus"></i> Tambah Item</button>
                                <button class="btn btn-info text-right mb-3 mr-1" onclick="getDataOrder()"><i class="fas fa-redo"></i> Reload</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
