    ...
    <div class="modal-content">
      ...
      <form id="form-confirm-kwitansi">
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="btn-confirm-kwitansi" class="btn btn-primary">Konfirmasi Kwitansi</button>
        </div>
      </form>
    </div>
  </div>
...
<div class="modal fade" id="modalPrintKwitansi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3>Print Kwitansi</h3>
      </div>
      <div class="modal-body">
        <div id="printKwitansiContent" class="m-3">

        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" id="btn-print-kwitansi" class="btn btn-primary">Cetak Kwitansi</button>
      </div>
    </div>
  </div>
</div>