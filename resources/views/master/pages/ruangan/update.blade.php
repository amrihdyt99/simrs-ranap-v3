                        ...
                        <div class="card-body">
                            <form action="{{route('master.ruangan.update', $ruangan->RoomID)}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$ruangan->IP}}" class="form-control"
                                        id="IP" name="IP">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="IsActive" name="IsActive" class="form-control select2bs4">
                                        ...
                                        <option value="1" {{ $ruangan->IsActive == '1' ? 'selected' : '' }}>Aktif</option>
                                        <option value="0" {{ $ruangan->IsActive == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                                    </select>
                                </div>
