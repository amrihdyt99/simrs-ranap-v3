              ...
              <form id="formDaftarMasalah" action="{{ route('master.draft.store') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('draft_kategori') is-invalid @enderror"
                    id="draft_kategori" name="draft_kategori">
                </div>
