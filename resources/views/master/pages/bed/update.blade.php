                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="service_unit_id" name="service_unit_id" class="form-control select2bs4" required>
                                                ...
                                                <option value="{{ $row->ServiceUnitID }}"
                                                    {{ $row->ServiceUnitID == $bed->service_unit_id ? 'selected' : '' }}>
                                                    {{ $row->ServiceUnitName }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                id="bed_code" name="bed_code" value="{{ $bed->bed_code }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="gc_type_of_bed" name="gc_type_of_bed" class="form-control select2bs4">
                                                ...
                                                <option value="X0126^02" {{ $bed->gc_type_of_bed == 'X0126^02' ? 'selected' : '' }}>SINGLE BED</option>
                                                <option value="X0126^05" {{ $bed->gc_type_of_bed == 'X0126^05' ? 'selected' : '' }}>ICU BED</option>
                                                <option value="X0126^01" {{ $bed->gc_type_of_bed == 'X0126^01' ? 'selected' : '' }}>ISO BED</option>
                                                <option value="X0126^04" {{ $bed->gc_type_of_bed == 'X0126^04' ? 'selected' : '' }}>MHO BED</option>
                                                <option value="X0126^03" {{ $bed->gc_type_of_bed == 'X0126^03' ? 'selected' : '' }}>SHD BED</option>
                                            </select>
                                        </div>
                                    </div>
