...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Input Data Class Category</h1>
      </div>
    </div>
  </div><!-- /.container-fluid -->
</section>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <form action="{{ route('master.class-category.store') }}" method="POST">
                @csrf
                <div class="form-group">
                  <label for="ClassCategoryCode">Class Category Code</label>
                  <input type="text" class="form-control @error('ClassCategoryCode') is-invalid @enderror"
                    id="ClassCategoryCode" name="ClassCategoryCode" required>
                </div>
                @error('RoomCode')
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('ClassCategoryName') is-invalid @enderror"
