            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('master.patient.update', $patient->MedicalNo) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        <label for="MedicalNo">MRN</label>
                                        <input type="text" value="{{ $patient->MedicalNo }}"
                                            class="form-control @error('MedicalNo') is-invalid @enderror" id="MedicalNo"
                                            name="MedicalNo" required>
                                    </div>
                                    @error('MedicalNo')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{ $patient->SSN }}"
                                            class="form-control @error('SSN') is-invalid @enderror" id="SSN" name="SSN">
                                    </div>
                                    @error('SSN')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $patient->MiddleName }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $patient->PatientName }}"
                                            class="form-control @error('PatientName') is-invalid @enderror" id="PatientName"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $patient->PatientNameOnCard }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $patient->CityOfBirth }}"
                                            class="form-control @error('CityOfBirth') is-invalid @enderror" id="CityOfBirth"
                                            name="CityOfBirth" required>
                                    </div>
                                    @error('CityOfBirth')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
