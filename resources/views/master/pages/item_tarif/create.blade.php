    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <form id="formItem" action="{{ route('master.item-tarif.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select id="SiteCode" name="SiteCode" class="form-control select2bs4">
                        ...
                        @foreach ($site as $cd)
                        <option value="{{ $cd->SiteCode }}">{{ $cd->SiteName }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select id="GCMember" name="GCMember" class="form-control select2bs4">
                        ...
                        <option value="X0103^001">Gold</option>
                        <option value="X0103^004">None</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select id="ClassCategoryCode" name="ClassCategoryCode" class="form-control select2bs4">
                        ...
                        <option value="{{ $cd->ClassCategoryCode }}">{{ $cd->ClassCategoryName }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="datetime-local"
                        class="form-control" id="DocumentDate" name="DocumentDate" value="">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="datetime-local"
                        class="form-control" id="StartingDate" name="StartingDate" value="">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="datetime-local"
                        class="form-control" id="EndingDate" name="EndingDate" value="">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control currency"
                        id="StandardPrice" name="StandardPrice">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control currency"
                        id="CustomerPrice" name="CustomerPrice">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control currency"
                        id="PersonalPrice" name="PersonalPrice">
                    </div>
                  </div>
