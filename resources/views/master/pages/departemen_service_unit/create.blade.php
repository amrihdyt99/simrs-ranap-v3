    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <form action="{{ route('master.departement-service-unit.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <select id="SiteDepartmentID" name="SiteDepartmentID" class="form-control select2bs4">
                    ...
                    <option value="{{ $cd->SiteDepartmentID }}">{{ $cd->DepartmentName }}</option>
                    @endforeach
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select id="ServiceUnitCode" name="ServiceUnitCode" class="form-control select2bs4">
                    ...
                    <option value="{{ $cd->ServiceUnitCode }}">{{ $cd->ServiceUnitName }}</option>
                    @endforeach
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control"
                    id="ContactPerson1" name="ContactPerson1">
                </div>
