    ...
    ->group(function () {
        ...
        Route::prefix('view-injector')->name('view_injector.')->group(function () {
            Route::prefix('perawat')->name('perawat.')->middleware(['auth', 'shift'])->group(function () {
                ...
                Route::post('assesment_resiko_jatuh_humpty_dumpty', [\App\Http\Controllers\ZxcNyaaUniversal\NyaaViewInjectorController::class, 'assesment_resiko_jatuh_humpty_dumpty'])->name('assesment_resiko_jatuh_humpty_dumpty');
                Route::post('assesment_resiko_jatuh_neonatus', [\App\Http\Controllers\ZxcNyaaUniversal\NyaaViewInjectorController::class, 'assesment_resiko_jatuh_neonatus'])->name('assesment_resiko_jatuh_neonatus');
                Route::post('assesment_resiko_jatuh_skala_morse', [\App\Http\Controllers\ZxcNyaaUniversal\NyaaViewInjectorController::class, 'assesment_resiko_jatuh_skala_morse'])->name('assesment_resiko_jatuh_skala_morse');
                ...
                Route::post('print-transfer-internal', [\App\Http\Controllers\ZxcNyaaUniversal\NyaaViewInjectorController::class, 'print_transfer_internal'])->name('print-transfer-internal');
