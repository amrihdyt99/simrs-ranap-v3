...
class DischargeController extends Controller
{
    public function discharge(RegistrationInap $patient)
    {
        ...
        $data['diagnoses'] = PasienDiagnosa::where('pdiag_reg', $patient->reg_no)->get();
        $data['procedures'] = PasienProsedur::where('pprosedur_reg', $patient->reg_no)->get();
        $data['discharge'] = PasienDischarge::where('pdischarge_reg', $patient->reg_no)->get();

        return view('case-manager.pages.patient.discharge', $data);
    }
    ...
    public function createDiagnose(RegistrationInap $patient)
    {
        ...
        return view('case-manager.pages.diagnose-procedure.create-diagnose', $data);
    }
    ...
    public function createProcedure(RegistrationInap $patient)
    {
        ...
        return view('case-manager.pages.diagnose-procedure.create-procedure', $data);
    }
    ...
    public function dischargeInfo(RegistrationInap $patient)
    {
        ...
        return view('case-manager.pages.discharge-info.create', $data);
    }
    ...
    public function storeDischargeInfo(Request $request)
    {
        ...
        return redirect()->route('case-manager.patient.discharge', $patient);
    }
