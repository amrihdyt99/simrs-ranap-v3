...
class DetailPasienDietitianController extends Controller
{
    ...
    public function ajax_index($request)
    {
        ...
        ->editColumn('aksi_data', function ($query) use ($request) {
                return
                ( '<a href="'
                . route('dietitian.patient_detail', ['MedicalNo' => $query->MedicalNo])
    ...
    public function ajax_index2($request, $id)
    {
        ...
        ->editColumn('aksi_data', function ($query) use ($request) {
                return
                ( '<a href="'
                . route('dietitian.patient_detail_registrasi', [$query->reg_no])
