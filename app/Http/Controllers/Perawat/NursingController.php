        ...
        try {
            ...
            if ($request->type == 'intensif') {
                $data = [
                    ...
                    'transfer_waktu_hubungi' => Carbon::parse($request->transfer_waktu_hubungi)->toDateTimeString(),
                    ...
                    'ditransfer_waktu' =>  Carbon::parse($request->ditransfer_waktu)->toDateTimeString(),
                    'diterima_oleh_nama' => $request->perawat_tujuan,
